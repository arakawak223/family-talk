...
export const QUESTIONS: MessageQuestion[] = [
  ...
  { id: 'q-feel-8', content: '今、誰かにぎゅっとしてもらいたい？', type: 'question', category: 'feeling', icon: '🤗' },
  { id: 'q-feel-9', content: '今日、どんな音楽が聴きたい気分？', type: 'question', category: 'feeling', icon: '🎵' },
  ...
  { id: 'q-feel-19', content: '今、心の中で歌ってる曲は？', type: 'question', category: 'feeling', icon: '🎶' },
  ...
  { id: 'q-feel-23', content: '心がザワザワする時、どうしてる？', type: 'question', category: 'feeling', icon: '🌊' },
  ...
  { id: 'q-mem-11', content: '一番好きだった先生は？', type: 'question', category: 'memory', icon: '👨‍🏫' },
  ...
  { id: 'q-mem-15', content: '学校で一番楽しかった行事は？', type: 'question', category: 'memory', icon: '🏫' },
  ...
  { id: 'q-mem-23', content: '運動会の思い出は？', type: 'question', category: 'memory', icon: '🏃' },
  ...
  { id: 'q-dream-14', content: '挑戦してみたいスポーツは？', type: 'question', category: 'dream', icon: '⚽' },
  { id: 'q-dream-15', content: '開いてみたいお店は？', type: 'question', category: 'dream', icon: '🏪' },
  { id: 'q-dream-16', content: '飼ってみたい動物は？', type: 'question', category: 'dream', icon: '🐕' },
  { id: 'q-dream-17', content: '演奏してみたい楽器は？', type: 'question', category: 'dream', icon: '🎸' },
  ...
  { id: 'q-thanks-13', content: '持っていてうれしいものは？', type: 'question', category: 'gratitude', icon: '🎒' },
  { id: 'q-thanks-14', content: '友達がいてくれて感謝！どんな友達？', type: 'question', category: 'gratitude', icon: '👯' },
  ...
  { id: 'q-fun-4', content: '好きな季節とその理由は？', type: 'question', category: 'fun', icon: '🌸' },
  ...
  { id: 'q-fun-14', content: '好きな色とその理由は？', type: 'question', category: 'fun', icon: '🎨' },
  { id: 'q-fun-15', content: 'スーパーヒーローになれたら、どんな能力がほしい？', type: 'question', category: 'fun', icon: '🦸' },
  { id: 'q-fun-16', content: '世界中の食べ物で、一番好きなのは？', type: 'question', category: 'fun', icon: '🍕' },
  { id: 'q-fun-17', content: '映画の主人公になれるなら、どの映画？', type: 'question', category: 'fun', icon: '🎥' },
  { id: 'q-fun-18', content: '自分を食べ物に例えると？', type: 'question', category: 'fun', icon: '🍎' },
  ...
  { id: 'q-family-4', content: '兄弟・姉妹との思い出は？', type: 'question', category: 'memory', icon: '👧' },
  ...
  { id: 'q-family-8', content: '家族にサプライズするなら何する？', type: 'question', category: 'dream', icon: '🎊' },
  ...
  { id: 'q-family-11', content: '家族みんなで見たい映画は？', type: 'question', category: 'fun', icon: '🎬' },
  { id: 'q-family-12', content: '家族の宝物は何？', type: 'question', category: 'gratitude', icon: '💎' },
  ...
  // 音楽・エンタメ系
  { id: 'q-music-1', content: '好きな歌手やバンドは？', type: 'question', category: 'fun', icon: '🎤' },
...
export const MESSAGES: MessageQuestion[] = [
  ...
  { id: 'm-snoopy-4', content: '友だちがいるって、それだけで宝物。', type: 'message', category: 'feeling', icon: '🐕' },
  ...
  { id: 'm-snoopy-13', content: '家族って、ケンカしても帰る場所がある安心感。', type: 'message', category: 'gratitude', icon: '🐕' },
  ...
  { id: 'm-snoopy-39', content: '一人じゃないよ。そばにいるからね。', type: 'message', category: 'feeling', icon: '🐕' },
  ...
  { id: 'm-pooh-6', content: '今日という日は、昨日の明日で、明日の昨日なんだよ。', type: 'message', category: 'feeling', icon: '🐻' },
  { id: 'm-pooh-7', content: '迷子になっても、友達がいれば怖くない。', type: 'message', category: 'gratitude', icon: '🐻' },
  ...
  { id: 'm-moomin-7', content: '新しい友達との出会いは、人生を豊かにするね。', type: 'message', category: 'memory', icon: '🦛' },
  ...
  { id: 'm-prince-3', content: '友達になるって、時間がかかること。', type: 'message', category: 'memory', icon: '👑' },
  ...
  { id: 'm-prince-6', content: 'たった一つのバラが特別なのは、時間をかけたから。', type: 'message', category: 'gratitude', icon: '🌹' },
  { id: 'm-prince-7', content: '子どもの頃の心を忘れないで。', type: 'message', category: 'memory', icon: '👑' },
  { id: 'm-prince-8', content: '笑うと、星が輝いて見えるよ。', type: 'message', category: 'fun', icon: '😊' },
  { id: 'm-prince-9', content: '大人になっても、大切なことを忘れないで。', type: 'message', category: 'feeling', icon: '👑' },
  ...
  { id: 'm-quote-5', content: '情けは人の為ならず。', type: 'message', category: 'gratitude', icon: '📜' },
  { id: 'm-quote-6', content: '千里の道も一歩から。', type: 'message', category: 'dream', icon: '📜' },
  { id: 'm-quote-7', content: '塵も積もれば山となる。', type: 'message', category: 'dream', icon: '📜' },
  ...
  { id: 'm-quote-11', content: '三人寄れば文殊の知恵。', type: 'message', category: 'gratitude', icon: '📜' },
  { id: 'm-quote-12', content: '石の上にも三年。', type: 'message', category: 'dream', icon: '📜' },
  { id: 'm-quote-13', content: '百聞は一見に如かず。', type: 'message', category: 'memory', icon: '📜' },
  ...
  { id: 'm-nature-5', content: '森の中を歩くと、気持ちがリフレッシュする。', type: 'message', category: 'feeling', icon: '🌲' },
  { id: 'm-nature-6', content: '川のせせらぎは、心を癒してくれる。', type: 'message', category: 'feeling', icon: '🏞️' },
